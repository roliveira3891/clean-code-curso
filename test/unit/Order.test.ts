...
test("Deve tentar criar um pedido vazioo com CPF inválido", function (){
...
test("Deve criar um pedido com 3 items com um cupom de desconto", function (){
    const cpf = "839.435.452-10";
    const order = new Order(cpf);
    order.addItem(new Item(1,"Música", "CD", 30),3);
    order.addItem(new Item(1,"Video", "DVD", 50),1);
...
test("Deve criar um pedido com 3 items com um cupom de desconto expirado", function (){
    const cpf = "839.435.452-10";
...
test("Deve criar um pedido com 3 items com o calculo de frete com a estrategia default", function (){
    const cpf = "839.435.452-10";
...
test("Deve criar um pedido com 3 items com o calculo de frete com a estrategia fixo", function (){
    const cpf = "839.435.452-10";
